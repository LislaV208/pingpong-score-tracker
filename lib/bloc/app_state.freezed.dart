...
class _$_AppState implements _AppState {
  const _$_AppState({required this.isInitialized});
  ...
  @override
  String toString() {
    return 'AppState(isInitialized: $isInitialized)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(isInitialized));
...
abstract class _AppState implements AppState {
  const factory _AppState({required final bool isInitialized}) = _$_AppState;
